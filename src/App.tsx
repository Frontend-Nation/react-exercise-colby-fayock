...
function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50">
      <div className="shadow rounded-lg bg-white p-12 py-11">
        <h1 className="text-4xl font-bold text-zinc-800 mb-1">Space Jelly Palooza</h1>
        ...
        <p>
          <span ref={buttonRef} className="inline-block relative">
            ...
            <ul className={`${isOpen ? 'opacity-100' : 'opacity-0 invisible' } absolute top-[calc(100%_+_.5em)] left-0 min-w-full bg-white rounded border shadow-lg py-2 px-1 transition-opacity`}>
              <li>
